  ...
  return (
    <main className="min-h-screen bg-[#060606] text-[#F5F0E8] py-24 md:py-32 relative overflow-hidden">
      ...
      <div className="absolute inset-0 z-0">
        ...
        <div className="absolute bottom-0 left-0 w-[500px] h-[500px] bg-[#E8D48B]/5 rounded-full blur-[120px]" />
      </div>
        ...
        <div className="max-w-4xl">
          ...
          >
            <div className="flex items-center space-x-4 mb-8">
              <div className="w-12 h-12 rounded-2xl bg-[#D4AF37]/20 flex items-center justify-center border border-[#D4AF37]/30">
            ...
            <div className="space-y-12 text-[#A09882] leading-relaxed">
              <section>
                <h2 className="text-xl font-bold text-[#F5F0E8] uppercase tracking-widest mb-4">Introduction</h2>
                <p>
              ...
              <section>
                <h2 className="text-xl font-bold text-[#F5F0E8] uppercase tracking-widest mb-4">The Data I Collect</h2>
                <p>
              ...
              <section>
                <h2 className="text-xl font-bold text-[#F5F0E8] uppercase tracking-widest mb-4">How I Use Your Data</h2>
                <p>
              ...
              <section>
                <h2 className="text-xl font-bold text-[#F5F0E8] uppercase tracking-widest mb-4">Data Storage & Security</h2>
                <p>
              ...
              <section>
                <h2 className="text-xl font-bold text-[#F5F0E8] uppercase tracking-widest mb-4">Third-Party Services</h2>
                <p>
              ...
              <section>
                ...
                <p>
                  ...
                  <br />
                  <span className="text-[#D4AF37] font-bold">geraldvillaceran01@gmail.com</span>
                </p>
              </section>
