...
export default function TermsOfService() {
  return (
    <main className="min-h-screen bg-[#060606] text-[#F5F0E8] py-24 md:py-32 relative overflow-hidden">
      {/* Ambient background */}
      <div className="absolute inset-0 z-0">
        <div className="absolute top-0 left-0 w-[500px] h-[500px] bg-[#E8D48B]/5 rounded-full blur-[120px]" />
        <div className="absolute bottom-0 right-0 w-[500px] h-[500px] bg-[#D4AF37]/5 rounded-full blur-[120px]" />
      </div>

      <div className="container mx-auto px-6 relative z-10">
        <Link 
          href="/" 
          className="inline-flex items-center space-x-2 text-[#D4AF37] hover:text-[#F5F0E8] transition-colors mb-12 group"
        >
        ...
        <div className="max-w-4xl">
          ...
          >
            <div className="flex items-center space-x-4 mb-8">
              <div className="w-12 h-12 rounded-2xl bg-[#E8D48B]/20 flex items-center justify-center border border-[#E8D48B]/30">
                <FileText className="w-6 h-6 text-[#E8D48B]" />
              </div>
              <h1 className="text-4xl md:text-6xl font-black italic uppercase tracking-tighter">
                Terms of <span className="text-[#E8D48B]">Service</span>
              </h1>
            </div>

            <div className="space-y-12 text-[#A09882] leading-relaxed">
              <section>
                <h2 className="text-xl font-bold text-[#F5F0E8] uppercase tracking-widest mb-4">Agreement to Terms</h2>
                <p>
              ...
              <section>
                <h2 className="text-xl font-bold text-[#F5F0E8] uppercase tracking-widest mb-4">Intellectual Property Rights</h2>
                <p>
              ...
              <section>
                <h2 className="text-xl font-bold text-[#F5F0E8] uppercase tracking-widest mb-4">Acceptable Use</h2>
                <p>
              ...
              <section>
                <h2 className="text-xl font-bold text-[#F5F0E8] uppercase tracking-widest mb-4">Disclaimer of Warranties</h2>
                <p>
              ...
              <section>
                <h2 className="text-xl font-bold text-[#F5F0E8] uppercase tracking-widest mb-4">Limitation of Liability</h2>
                <p>
              ...
              <section>
                <h2 className="text-xl font-bold text-[#F5F0E8] uppercase tracking-widest mb-4">Governing Law</h2>
                <p>
              ...
              <section>
                <h2 className="text-xl font-bold text-[#F5F0E8] uppercase tracking-widest mb-4">Contact</h2>
                <p>
                  If you have any questions about these terms, please contact me at: 
                  <br />
                  <span className="text-[#E8D48B] font-bold">geraldvillaceran01@gmail.com</span>
                </p>
              </section>

              <div className="pt-12 border-t border-[#F5F0E8]/10 text-[10px] font-bold tracking-widest uppercase">
